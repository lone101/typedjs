function(canvasContext, onpropertyChangedHandler) {
  var me = new _.base.class("CanvasWrapper", this);
  me.private.expand({
    m: Math,
    mr: Math.round,
    ms: Math.sin,
    ...
    matrixMultiply: function(m1, m2) {
      var result = me.private.createMatrixIdentity();
      for (var x = 0; x < 3; x++) {
        for (var y = 0; y < 3; y++) {
          var sum = 0;
          for (var z = 0; z < 3; z++) {
    ...
    init: function() {
      me.private.m_ = createMatrixIdentity();
      // Canvas context properties
      me.properties.set('strokeStyle', '#000', onpropertyChangedHandler);
      me.properties.set('fillStyle', '#000', onpropertyChangedHandler);
      me.properties.set('lineWidth', 1, onpropertyChangedHandler);
      me.properties.set('lineJoin', 'miter', onpropertyChangedHandler);
      me.properties.set('lineCap', 'butt', onpropertyChangedHandler);
      me.properties.set('miterLimit', 1, onpropertyChangedHandler);
      me.properties.set('globalAlpha', 1, onpropertyChangedHandler);
    }
